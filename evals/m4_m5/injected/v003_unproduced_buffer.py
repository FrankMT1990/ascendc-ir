...
"""注入 V003：sync 的 on 携带了尚未生产的 buffer。基线：legal/add_legal.py。"""
...
def v003_unproduced_buffer(x: gmptr(f32), y: gmptr(f32), z: gmptr(f32)):
    TILE, TILES = 2048, 8
